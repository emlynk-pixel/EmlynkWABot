...
describe("approving a police slip", () => {
    ...
    const approved = (date: string): ApproveResult => ({
        ...
        audit: { auditId: "a1", action: "APPROVE", adminId: "admin-1", adminName: "Test Admin", reason: null, previousStatus: "MANUAL_REVIEW", newStatus: "VERIFIED", policeSubmittedDate: date, createdDate: "2026-09-25T05:00:00.000Z" },
    });
    beforeEach(() => {
